...
'use strict';
  ...
  */
  ...
  function EntryListObserver (ajaxEndPoint,EEVersion) {
    this.ajaxEndPoint = ajaxEndPoint;
    this.EEVersion = parseFloat(EEVersion.split(".")[0] + '.' + EEVersion.split(".")[1])
    this.entryIds = [];
    this.entryIdsBefore = [];
  }
  ...
  EntryListObserver.prototype = {
    ...
    */
    ...
    observeFilters: function () {
      ...
      // Needed for version 2.4 and above
      if(this.EEVersion >= 2.4)
      {
